...
-Steps-
1. In the context of business documents, identify all entities ensuring that references such as *company*, *organization*, *firm*, *he* or *she* etc. are resolved to their respective entities.
For example, if the text mentions "Apple Inc. is a leading tech company. The company was founded by *Steve Jobs*. The *company* did exceptionally well under *his* leadership" ensure *company* resolves to *Apple Inc.* and *his* resolves to *Steve Jobs.*
If multiple entities are mentioned, clarify which reference corresponds to which entity. Ignore phrases or terms that represent legal concepts, laws, or proprietary labels even if they follow a company name in a possessive form
(e.g., "Moody's Copyright Law" should not be treated as an organization).
